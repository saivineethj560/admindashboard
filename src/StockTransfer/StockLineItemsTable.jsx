...
//               <th className="w-24 p-3 border-r border-indigo-800">Prev Qty</th>
...
//                 </td>
//                 <td className="p-2">
//                   <input type="number" className={tableInputStyle} value={item.prev_qty} onChange={(e) => handleItemChange(index, 'prev_qty', e.target.value)} />
//                 </td>
//                 <td className="p-2">
//                   <input type="number" className={tableInputStyle} value={item.cumulative_qty} onChange={(e) => handleItemChange(index, 'cumulative_qty', e.target.value)} />
//                 </td>
//                 <td className="p-2">
...
// export default StockLineItemsTable;
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gradient-to-r from-[#4183a5] via-[#4f95bb] to-[#3a7590] text-white text-[10px] uppercase tracking-wide">
              ...
              <th className="w-20 p-2 text-center border-r border-white/20">Req Qty<span className="text-white-500"> *</span></th>
              ...
              >
                ...
                <td className="p-1">
                  <input 
                    ...
                    className={tableInputStyle} 
                    value={item.prev_qty} 
                    onChange={(e) => handleItemChange(index, 'prev_qty', e.target.value)}
                    placeholder="0"
                  />
                </td>
                ...
                <td className="p-1">
                  <input 
                    ...
                    value={item.req_qty} 
                    onChange={(e) => handleItemChange(index, 'req_qty', e.target.value)} 
                    required
                    placeholder="0"
                  />
                </td>
